...
async def support(_, message: Message):
    ...
    await message.edit(
        f"<b>Userbot name - dolly\n\n"
        "GitHub: <a href=https://github.com/Kegaru/Dolly>Dolly userbot</a>\n"
        "Custom modules repository: <a href=https://t.me/NameNotFoand>"
        "owner userbot</a>\n"
        "Channel: @ZHIZN_PRYANIKA\n"
        f"Userbot version: 0.1"
